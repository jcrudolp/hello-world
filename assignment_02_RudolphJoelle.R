...
## Use `setwd()` if needed
setwd("/Users/joellerudolph/Downloads/dsc520")
...
colnames(voter_turnout_df2)<- c("Ward Precinct", "Ballots Cast", "Registered Voters", "Voter Turnout")
...
tables <- lapply(table_names, function(t) dbReadTable(db, t))
tables
